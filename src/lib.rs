...
pub use types::{User, Session, Account, Verification, AuthRequest, AuthResponse, CreateVerification};
...
mod tests {
    ...
    use crate::plugins::EmailPasswordPlugin;
    use crate::types::{HttpMethod, CreateUser};
    use serde_json::json;
    use std::sync::Arc;
